    ...
    return (
        <div className="wrapper-cart-confirmation-content container wrapper-padding">
            ...
            <div className="wrapper-summary">
                <p>
                    Vous avez commandé <span>3 journaux</span> en <span>abonnement</span> de la catégorie Sports.
                </p>
                <p>
                ...
                <p>
                    Ce montant vous sera prélevé sur votre paie tous les mois.
                </p>
                <p>
            ...
            <Link to="#" className="btn-action btn-secondary">Retour à la page d'accueil</Link>
        </div>
    );
  }
}
